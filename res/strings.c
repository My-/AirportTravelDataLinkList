...
void main(){
	...
	if (compare == 0){ printf("The first %d character of both strings are equal\n",number); }
	else if (compare > 0){ printf("String 1 is bigger when comparing %d characters\n",number); }
	else{ printf("String2 is bigger when comparing %d characters\n",number); }
	...
	strcpy(string1, string2); // String copy
	printf("String 1 now is %s and string 2 remain %s\n", string1, string2);
